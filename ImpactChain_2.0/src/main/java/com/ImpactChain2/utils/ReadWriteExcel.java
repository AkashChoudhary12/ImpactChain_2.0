...
public class ReadWriteExcel {
	...
	protected static void setExcelFile(final String Filename, final int SheetNumber) throws Exception {
...
//            ReadWriteExcel.ExcelWSheet=ReadWriteExcel.ExcelWBook.getSheet("");
	...
	protected static String getCellData(final int RowNum, final int ColNum) throws Exception {
	...
	protected static void setCellData(final String Result, final int RowNum, final int ColNum, final String Filename)
			throws Exception {
		try {
	...
	protected static String getvalue(final int i, final int j) {
		final DataFormatter formatter = new DataFormatter();
	...
	protected static String getDate(int i, int j) {
		ReadWriteExcel.Cell = ReadWriteExcel.ExcelWSheet.getRow(i).getCell(j);
	...
	protected static int getRowCount(String sheetName) {
	...
	protected static int getColumnCount(String sheetName) {
		int columnCnt = ReadWriteExcel.ExcelWBook.getSheet(sheetName).getRow(0).getLastCellNum();
		return columnCnt + 1;

	}

	protected boolean searchDataInExcel(String fileName, String SearchInSheetName, String verifyData) throws Exception {
	...
	protected static Object[][] getData(String fileName, String sheetName) throws Exception {
